...
class S {
  ...
  String get restaurant {
    return Intl.message('Meal', name: 'restaurant', desc: '', args: []);
  }

  /// `Media`
  String get movies {
    return Intl.message('Media', name: 'movies', desc: '', args: []);
  }
  ...
  /// `Global News`
  String get globalNews {
    return Intl.message('Global News', name: 'globalNews', desc: '', args: []);
  }
